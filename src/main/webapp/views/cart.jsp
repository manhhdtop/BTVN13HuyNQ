			...
			<div class="container">
				...
				<div class="row cart-buttons">
					<div class="col-lg-5 col-md-5">
						<div class="site-btn btn-continue">Continue shooping
						</div>
					</div>
					<div class="col-lg-7 col-md-7 text-lg-right text-left">
						<div class="site-btn btn-clear">Clear cart</div>
						<div class="site-btn btn-line btn-update">Update Cart
						</div>
					</div>
				</div>
			</div>
					...
					<div class="row">
							...
							<div class="shipping-info">
								...
								<div class="shipping-chooes">
									<div class="sc-item">
										...
										<label for="one">Next day delivery
											<span>$4.99</span>
										</label>
									</div>
									<div class="sc-item">
										<input type="radio" name="sc" id="two">
										<label for="two">Standard delivery
											<span>$1.99</span>
										</label>
									</div>
									<div class="sc-item">
										<input type="radio" name="sc"
										       id="three">
										<label for="three">Personal Pickup
											<span>Free</span>
										</label>
									</div>
								</div>
						...
						<div class="offset-lg-2 col-lg-6">
							<div class="cart-total-details">
								...
								<a class="site-btn btn-full"
								   href="checkout.jsp">Proceed to checkout
								</a>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-2 col-md-4 col-sm-6">
						<div class="footer-widget">
							...
							<div class="text-box">
								...
								<p>1481 Creekside Lane Avila Beach, CA
									93424, </p>
