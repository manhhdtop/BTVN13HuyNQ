							...
							<div class="col-lg-6 mb-4">
								...
								<div class="card shadow mb-4">
									...
									<div class="card-body">
										...
										<p>Add some quality, svg illustrations
											to your project courtesy of
											<a target="_blank" rel="nofollow"
											   href="https://undraw.co/">unDraw
											</a>
								...
								<div class="card shadow mb-4">
									...
									<div class="card-body">
										<p>SB Admin 2 makes extensive use of
										...
										<p class="mb-0">Before working with this
											theme, you should become familiar
