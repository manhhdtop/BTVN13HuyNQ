				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="product-content">
							...
							<div class="color-choose">
								...
								<div class="cs-item">
									<input type="radio" name="cs"
									       id="black-color" checked>
									<label class="cs-black"
									       for="black-color"></label>
								</div>
								<div class="cs-item">
									<input type="radio" name="cs"
									       id="blue-color">
									<label class="cs-blue"
									       for="blue-color"></label>
								</div>
								<div class="cs-item">
									<input type="radio" name="cs"
									       id="yollow-color">
									<label class="cs-yollow"
									       for="yollow-color"></label>
								</div>
								<div class="cs-item">
									<input type="radio" name="cs"
									       id="orange-color">
									<label class="cs-orange"
									       for="orange-color"></label>
								</div>
							</div>
							...
							<a href="#" class="site-btn btn-line">ADD TO CART
							</a>
						</div>
					</div>
				</div>
					...
					<div class="col-lg-3">
						<div class="product-item">
							...
							<div class="product-info">
								...
								<p>$39.90</p>
								<a href="#" class="site-btn btn-line">ADD TO
									CART
								</a>
							</div>
						</div>
